...
namespace
{
    ...
    {
        // Shared with all top-level dialogs (BPM measure, log settings,
        // plugin manager, inline MainWindow dialogs) via NativeWindowTheme.
        return NativeWindowTheme::dialogStyleSheet(baseBg);
    }
